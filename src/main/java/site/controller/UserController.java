...
public class UserController {
    ...
    public String signip(@Valid final User user, BindingResult bindingResult, HttpServletRequest request) {
        ...
        if (existingUser != null) {
            bindingResult.rejectValue("email", "email.exists",
                "This email already exists, please use forgot password");
    ...
    public String createNewPassPost(@RequestParam(required = true) String tokenId,
        @RequestParam(required = true) String password, @RequestParam(required = true) String cpassword,
    ...
    public String successfulPasswordChange(@ModelAttribute User user, Model model) {
        String msg =
            "Successfully changed password for user: " + user.getFirstName() + " " + user.getLastName() +
                " (" + user.getEmail() + ") ";
    ...
    private String buildResetMailContent(User user, String tokenId, String fileName) throws IOException {
    ...
    private String buildWelcomeMailContent(User user, String fileName) throws IOException {
        String messageText = resourceAsString(fileName);
        messageText = messageText.replace("{user.firstName}", user.getFirstName());
        return messageText;
    }
